...
async def profile_games(steamid: str):
    numOfGames, totalPlayTime, averageRecentPlaytime, avgAchievementCompletion, totalCompletedAchievements, totalPossibleAchievements, top25GameNames, top25PictureURL = await StatsProcessor.getGames(steamid)
